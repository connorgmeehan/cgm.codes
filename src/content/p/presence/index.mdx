---
{
  ...
  "pubDate": "2018-05-10",
  "heroImage": "/blog/presence-showcase.webm",
  "team": [
...
<div class="flex justify-center">
    <EmbeddedTweet id="1187141240254390272" />
</div>
...
import ConceptDesignImg from './images/concept-design.png';

<GalleryImage image={ConceptDesignImg} alt='Concept art of what the final design would look like in the space' />
...
<div class="flex justify-center">
    <EmbeddedTweet id="1016487785706840064" />
</div>
...
<div class="flex justify-center">
    <EmbeddedTweet id="1022283702146031616" />
</div>
...
<div class="flex gap-4">
    <EmbeddedTweet id='1022434970084638721' position="left" />
    <EmbeddedTweet id='1023020453160341504' position="left" />
</div>
