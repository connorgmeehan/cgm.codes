...
{
  "title": "Koala & Joey",
  "description": "Aged care sucks.  User focused design project to optimise the aged care industry and promote active aging.",
  "pubDate": "2018-11-15",
  "heroImage": "/blog/koalajoey-showcase.mp4",
...
import ExploreIdeasImg from './images/koalajoey-exploreideas.png';

<GalleryImage class="mb-4" client:idle image={ExploreIdeasImg} alt="Ideas exploration" />
...
import LofiWiresImg from './images/koalajoey-lofi_2.png';

<GalleryImage class="mb-4" client:idle image={LofiWiresImg} alt="Low fidelity wireframes showing the app flow." />
...
import HifiWiresImg from './images/koalajoey-hifi_1.png';

<GalleryImage client:idle image={HifiWiresImg} alt="Low fidelity wireframes showing the app flow." />
...
import Glam1Img from './images/koalajoey-glamour_1.png';

<GalleryImage client:idle image={Glam1Img} alt="Image of app homepage showing potential tasks that can be completed." />

#### Task search page, showing voice recogniton capabilities and the list UI

import Glam2Img from './images/koalajoey-glamour_2.png';

<GalleryImage client:idle image={Glam2Img} alt="Image of task search showing the voice recognition capabilities, suited to those with lower dexterity. " />

#### Task request page showing how users can specify their needs with tasks they need support with

import Glam3Img from './images/koalajoey-glamour_3.png';

<GalleryImage client:idle image={Glam3Img} alt="Image of task planning flow showing how users can enter their needs as a per task basis." />

#### Confirmation page allowing users to double check the information they've entered is correct

import Glam4Img from './images/koalajoey-glamour_4.png';

<GalleryImage client:idle image={Glam4Img} alt="Confirmation screen showing all the information the user has entered so they can double check that it's correct." />
